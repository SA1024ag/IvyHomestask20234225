...
const FORENSIC_ANSWERS = [
  ...
  },
  {
    ...
    answer: '44 IDs',
    detail: '44 records across 4 categories: (a) carpet_area > super_built_up_area (11), (b) floor > total_floors (11), (c) negative/zero prices (11), (d) apartments/villas/houses with bedroom=0 (11). Includes: 100-5000050, 100-5000610, DWE-5001919, MAG-5000744, SQU-5000137, ZER-5001536 and 38 more.',
    badge: 'corrupt_listing_ids',
    color: '#ef4444',
  },
  {
    q: 'Q5',
    question: 'Total monthly rent (all Mulund West rentals)',
    answer: '₹88,59,500',
    detail: 'Sum of price across all 246 retrievable Mulund West rentals (live + inactive) from /v1/rentals. Question asks for all retrievable records in assigned locality, no is_live filter applied.',
  ...
  },
  {
    ...
    detail: 'Mean of (price / carpet_area) across 1,308 active 2BHK listings, excluding corrupt (Q4) and fake (Q9) IDs. Uses raw carpet_area values as reported — magichomes reports sqm for 124 records, inflating the average vs corrected baseline of ~₹31,849.',
